...
> 来源：[CTF Wiki - SSRF](https://ctf-wiki.org/web/ssrf/)
> 
> 上一页：[CSRF 跨站请求伪造](./csrf.md) | 下一页：[PHP 代码审计](./php/code-audit.md)
...
- [SSRF 简介](#ssrf-简介)
- [SSRF 漏洞出现的场景](#ssrf-漏洞出现的场景)
- [常用的后端实现](#常用的后端实现)
- [阻碍 SSRF 漏洞利用的场景](#阻碍-ssrf-漏洞利用的场景)
- [利用 SSRF 进行端口扫描](#利用-ssrf-进行端口扫描)
- [协议利用](#协议利用)
- [绕过姿势](#绕过姿势)
- [危害](#危害)
- [参考资料](#参考资料)
...
- 利用 Enclosed alphanumerics：`ⓔⓧⓐⓜⓟⓛⓔ.ⓒⓞⓜ` ==> `example.com`
...
- [bilibili 某分站从信息泄漏到 ssrf 再到命令执行](https://_thorns.gitbooks.io/sec/content/bilibilimou_fen_zhan_cong_xin_xi_xie_lu_dao_ssrf_z.html)