...
var agentSkillsSpecFrontMatterKeys = map[string]struct{}{
	...
	// Legacy compatibility keys accepted on read/write, then normalized into metadata.
	"version": {}, "tags": {}, "triggers": {}, "aliases": {}, "domains": {}, "stages": {},
	"target_types": {}, "bundle_of": {}, "depends_on": {},
	"recommended_tools": {}, "required_tools": {}, "role_hints": {}, "autoload_priority": {},
}
