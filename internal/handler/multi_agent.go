...
func (h *AgentHandler) MultiAgentLoopStream(c *gin.Context) {
	...
	orch := prep.EffectiveOrchestration
	...
	h.syncConversationMemory(conversationID, req.Message, result.Response, curHistory)
	...
	sendEvent("response", result.Response, map[string]interface{}{
		...
		"effectiveOrchestration": effectiveOrch,
	})
	sendEvent("done", "", map[string]interface{}{"conversationId": conversationID})
}
...
func (h *AgentHandler) MultiAgentLoop(c *gin.Context) {
	...
	h.syncConversationMemory(prep.ConversationID, req.Message, result.Response, prep.History)
	...
	c.JSON(http.StatusOK, ChatResponse{
		...
		ConversationID:         prep.ConversationID,
		EffectiveOrchestration: prep.EffectiveOrchestration,
		Time:                   time.Now(),
	})
}
